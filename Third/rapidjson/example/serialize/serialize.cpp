...
protected:
    ...
    void Serialize(Writer& writer) const {
        ...
        writer.std::string(name_.c_str(), (SizeType)name_.length()); // Suppling length of string is faster.

        writer.std::string("age");
        writer.Uint(age_);
    }
...
public:
    ...
    void Serialize(Writer& writer) const {
        ...
        writer.std::string("school");
        writer.std::string(school_.c_str(), (SizeType)school_.length());

        writer.std::string("GPA");
        writer.Double(GPA_);
...
public:
    ...
    void Serialize(Writer& writer) const {
        ...
        writer.std::string("married");
        writer.Bool(married_);

        writer.std::string(("dependents"));
        writer.StartArray();
