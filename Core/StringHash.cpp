...
StringHash* StringManager::GetOrCreateName(const char* pChar)
{
	...
	// thread lock
	unsigned int uiCRCCode = MathInstance::GetMathInstance().CRC32Compute(pChar, (unsigned int)strlen(pChar));
...
StringHash* StringManager::GetOrCreateName(const std::string& str)
{
