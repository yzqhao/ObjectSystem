...
void RttiManager::RegisterClass(const std::string& name, Rtti* rtti)
{
	m_mapRtti.insert({name, rtti});
}

const Rtti* RttiManager::GetRttiByName(const std::string& RttiName)
{
...
const RttiInfoIn* RttiManager::GetRttInfoByName(const std::string& RttiName)
{
...
void RttiManager::GetChildrenName(const std::string& name, std::vector<std::string>& outChildrenNames)
{
