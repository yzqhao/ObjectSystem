# 
set(PRECOMPILE_TOOLS_PATH "${ROOT_PATH}/bin")
set(PRECOMPILE_PARAMS_IN_PATH "${ROOT_PATH}/Engine/precompile/precompile.json.in")
...
if (CMAKE_HOST_WIN32)
    ...
    set(sys_include "${ROOT_PATH}") 
elseif(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux" )
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/Parser)
    set(sys_include "/usr/include/c++/9/;${ROOT_PATH}") 
...
elseif(CMAKE_HOST_APPLE)
    ...
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/Parser)
    set(sys_include "${osx_sdk_platform_path_test}/../../Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1;${ROOT_PATH}") 
endif()
