...
#define TypeMetaDef(class_name, ptr) \
    JYE::Reflection::ReflectionInstance(JYE::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                            (class_name*)ptr)

#define TypeMetaDefPtr(class_name, ptr) \
    new JYE::Reflection::ReflectionInstance(JYE::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                                (class_name*)ptr)
...
namespace Reflection
{
    class META_API TypeMetaRegisterinterface
    {
    public:
    ...
    class META_API ReflectionInstance
    {
    public:
